                ...
                <div class="mb-2 mt-2 row">
                    <div class="col-md-4">
                        <div class="mb-3 input-group">
                            <select @change="schemeTriggered(1)" v-model="selected_scheme"
                                class=" mx-1 form-control d-inline-block" style="width: 240px;">
                        ...
                        <div v-for="key in Object.keys(appropriations)" class="row">
                            <div class="col-md-4 col-lg-4 mb-4 ">
                                <div class="px-3 bg-white rounded-lg">
                                    <div style="width: 100%; height:200px"><canvas
                                            style="position:relative;height:200px !important;"
                                            :id="'report_pie' + key"></canvas></div>
                                    {{ initPieChart('report_pie' + key, [appropriations[key].reduce((t, v) => {
                                        return
                                        t + v[0]
                                    }, 0), appropriations[key].reduce((t,v)=>{return t+v[1]},0)], key)}}
                                </div>
                            </div>
    ...
    methods: {
        async reloadSchemes() {
            ...
            if (res?.data) {
                ...
                this.selected_scheme = this.schemes[0]
