...
export const helpers = {
    ...
    dynamic_data:{
        ...
        Bank_Name: { required:1, show: 1, activate: 1, value: '', type: 'text', for: '' },
        ...
        'VAT_%': { required:0, show: 1, activate: 1, value: 7.5, type: 'number', for: 'tax', amount: 0 },
        'VAT_₦': { required:0, show: 0, activate: 1, value: 0, type: 'number', for: 'tax', amount: 0 },
        'Withholding_Tax_%': { required:0, show: 1, activate: 1, value: 5, type: 'number', for: 'tax', amount: 0 },
        'Withholding_Tax_₦': { required:0, show: 0, activate: 1, value: 0, type: 'number', for: 'tax', amount: 0 },
        'Stamp_Duty_%': { required:0, show: 1, activate: 1, value: 1, type: 'number', for: 'tax', amount: 0 },
